...
<div class="blogPost">
  ...
  <p style="float:left; width:40%; height:400px;">Na een lange nacht rouwen om Bert zijn overlijden zijn kameraad Thomas en Pater naar Jacob Hut gestapt. Niet veel later zijn de kameraden wedergekeerd met een gloednieuw lichaam voor Bert, samen met Bert zijn bewustzijn(SD kaartje) is Bert herboren in een nieuw lichaam als PI 3 model B+.<p>
...
<div class="blogPost">
  ...
  <object  width="600" height="450" data="https://www.youtube.com/watch?v=wIQAVbh_THs"></object>
  <div style="clear:both;"></div>
<hr>
<div class="blogPost">
