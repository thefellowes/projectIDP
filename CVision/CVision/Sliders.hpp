...
public:
	...
	Sliders(std::string windowName="", int amount=0, std::string defaultSliderName="", int defaultMinValue=0, int defaultMaxValue=100, bool newWindow=true, std::vector<std::string> sliderNames={}, std::vector<int> minValues={}, std::vector<int> maxValues={}, std::vector<int> initValues={}) {
		if (windowName == "") {
